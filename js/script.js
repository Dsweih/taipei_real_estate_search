(function(window) {
    ...
    // 將地址轉為地理座標
    var getGeocode = function(data, index) {
        // 屋齡
    ...
    // Calculate age
    var getAge = function(buildDateStr) {
        if (buildDateStr !== '') {
    ...
    // Add markers to the map
    var addMarker = function(address, position, unitPrice) {
    ...
    // Create detail list of markers
    var createList = function(obj, marker) {
